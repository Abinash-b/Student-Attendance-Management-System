    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
            <li class="nav-item active">
                <a class="nav-link" href="Admin_Record_Attendance.php">RECORD ATTENDANCE</a>
            </li>
        </ul>
    </div>
...
<div class="container-fluid ">
    ...
    <div class="row ml-sm-3 ">
        <div class="col-sm-3 sticky" style="background-color:lavender; height:600px; font-size:30px; ">
            ...
            <form method="POST">
                    ...
                    <div class="col-sm-12 "  >
                        <div class="input-group mb-3 input-group-sm" style="height:40px;">
                            <div class="input-group-prepend">
                                ...
                                <input type="text" id="ARTeacher_ID" name="ARTeacher_ID" class="form-control" required="Please fill this" placeholder="Example:F00001" style="height:40px;"
                                value="<?php if(isset($_SESSION["teacher"])){echo $_SESSION["teacher"]; }?>">
                
                                <div class="input-group-append">
                                    <input class="btn btn-secondary" id="ARSelect" name="ARSelect" type="submit" value="SELECT">
                                </div>
             ...
             <form method="POST">
                ...
                if(isset($_POST['ARSelect'])||isset($_POST['ARTeacher_ID']))
                    {
                        $_SESSION["teacher"]=$_REQUEST['ARTeacher_ID'];
            ...
            <form method="POST">
                ...
                <div class="row mx-sm-3 mt-sm-5" >
                    <div class="col-sm-12 "  >
                        <div class="input-group mb-3 input-group-sm" style="height:40px;">
                            ...
                            <select class="form-control" id="ARClass" name="ARClass" required="Please fill this" style="height:40px;">
                ...
                <div class="row mx-sm-3 mt-sm-3" >
                    <div class="col-sm-12 "  >
                        <div class="input-group mb-3 input-group-sm" style="height:40px;">
                            ...
                            <select class="form-control" id="ARSubject" name="ARSubject" required="Please fill this" style="height:40px;">
                ...
                <div class="row mx-sm-3 mt-sm-3" >
                    <div class="col-sm-12 "  >
                        <div class="input-group mb-3 input-group-sm" style="height:40px;">
                            ...
                            <textarea type="text" id="datereal" name="ARDate" rows="1" class="form-control" required="Please fill this" disabled style="height:40px;font-size:18px;"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mx-sm-3 mt-sm-3" >
                    <div class="col-sm-12 "  >
                        <div class="input-group mb-3 input-group-sm" style="height:40px;">
                            ...
                            <select class="form-control" id="ARTime" name="ARTime" required="Please fill this" style="height:40px;" >
                ...
                <div class="row mx-sm-3 mt-sm-3" >
                    <div class="col-sm-12 "  >
                        <input type="submit" class="btn btn-secondary btn-block" name="ARGetData" value="GET CLASS DATA">
                    </div>
                </div>
            </form>
        </div>
        ...
        <?php 
        if(isset($_POST['ARGetData']))
         { 
        if(isset($_POST['ARClass'])&&isset($_POST['ARSubject'])&&($_POST['ARTime']))
            {
            $_SESSION['class']=$_POST['ARClass']; $_SESSION['subject']=$_POST['ARSubject']; $_SESSION['time']=$_POST['ARTime'];
                    echo("<meta http-equiv='refresh' content='1'>");
            }


        }
        if(isset($_SESSION['class'])&&isset($_SESSION['teacher'])&&isset($_SESSION['subject']))
           {  
              $checkquery="select * from teaches where t_id='".$_SESSION["teacher"]."' AND sub_id='".$_SESSION['subject']."' AND c_id='".$_SESSION['class']."';"; 
        ...
        <div class="col-sm-9">
            <div class="row mx-sm-3 mt-sm-1" >
                <div class="col-sm-12 " >
                    <div class="row">
                    <input class="form-control" id="ARmyInput" type="text" placeholder="Search...">
                    <br>
                    </div>
                    <form method="POST">
...
$(document).ready(function(){
  $("#ARmyInput").on("keyup", function() {
    var value = $(this).val().toLowerCase();
    $("#ARmyTable tr").filter(function() {
...
document.getElementById("datereal").innerHTML = (("0"+dt.getDate()).slice(-2)) +"-"+ (("0"+(dt.getMonth()+1)).slice(-2)) +"-"+ (dt.getFullYear());
 ...
 <?php      
            ...
            $index=$_POST["nota_$i"];
            $cquery=$cquery."INSERT INTO record_attendance VALUES ('{$index}','{$status[0]}',curdate(),'".$_SESSION['time']."','{$values['s_id']}','".$_SESSION["teacher"]."','".$_SESSION["subject"]."');";
