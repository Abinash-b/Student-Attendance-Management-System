...
<center>
        <table>
            <tr class="card">
                ...
                <td class="button3 button4">
                    <a href="student_login.php"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFzmo3JquummKiRTU3gvVz2ANxDGXMsHRKZw&usqp=CAU"; height="200px" width="200px">
                    <p style="font-size:200%;">Student Login</p></a>
                </td>
            </tr>
        </table>
</center>
