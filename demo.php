                    ...
                    <div class="row mt-sm-2 justify-content-center">
                        <div class="col-sm-12 ">
                            <div class="input-group mb-3 input-group-sm">
                                ...
                                <textarea type="text" id="fuAddress" name="fuAddress" class="form-control"  rows="3" value="<?php echo $val['address'];?>"></textarea>
                            </div>
                        </div>
                    </div>
                    <?php $i=0;
...
{break;}
 ...
 if($i==$numb)
{   $tphone="DELETE FROM `teacher_phone` WHERE t_id=$tid;";$tcs="DELETE FROM `teaches` WHERE t_id=$tid;";
