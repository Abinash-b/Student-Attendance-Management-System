    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
            <li class="nav-item active">
                <a class="nav-link" href="Admin_Defaulter_List.php">DEFAULTER LIST</a>
            </li>
        </ul>
    </div>
...
<div class="container-fluid ">
    <div class="row ml-sm-3 ">
        <div class="col-sm-3 " style="background-color:lavender; height:600px; font-size:30px;">
            ...
            <div class="row mx-sm-3 mt-sm-5" >
                <div class="col-sm-12 "  >
                    <div class="input-group mb-3 input-group-sm" style="height:40px;">
                        ...
                        <select class="form-control" id="ADDepartment" name="ADDepartment" required="Please fill this" style="height:40px;">
                        ...
                        <?php 
                                ...
                                {?><option value="<?php echo $dep['d_id'] ?>" <?php if(isset($_SESSION['depart'])&&($_SESSION['depart']==$dep['d_id'])){echo "selected";} ?>><?php echo $dep['d_name'] ?></option>;
                                <?php
                        ...
                        <div class="input-group-append">
                            <input class="btn btn-secondary" id="ADDeptSelect" name="ADDeptSelect" type="submit" value="SELECT">
                        </div>
                    </div>
                </div>
            </div>
                <?php if(isset($_POST['ADDeptSelect']))
                            {$_SESSION["depart"]=$_REQUEST['ADDepartment'];
            ...
            <div class="row mx-sm-3 mt-sm-3" >
                <div class="col-sm-12 "  >
                    <div class="input-group mb-3 input-group-sm" style="height:40px;">
                        ...
                        <select class="form-control" id="ADClass" name="ADClass" required="Please fill this" style="height:40px;">
                        ...
                        <div class="input-group-append">
                            <input class="btn btn-secondary" id="ADClassSelect" name="ADClassSelect" type="submit" value="SELECT">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <?php
            if(isset($_POST['ADClassSelect']))
                 {
                                  $_SESSION["class"]=$_REQUEST['ADClass'];
                                  echo("<meta http-equiv='refresh' content='1'>");
                   }
            ...
            <div class="row mx-sm-3 mt-sm-3" >
                <div class="col-sm-12 "  >
                    <div class="input-group mb-3 input-group-sm" style="height:40px;">
                        ...
                        <select class="form-control" id="ADSubject" name="ADSubject" required="Please fill this" style="height:40px;">
            ...
            <div class="row mx-sm-3 mt-sm-3" style="border:3px solid black ">
                <div class="col-sm-12 "  >
                    ...
                    <div class="input-group mb-3 input-group-sm mt-sm-3" style="height:40px;">
                        ...
                        <input type="date" id="ADStartDate" name="ADStartDate" class="form-control" required="Please fill this" style="height:40px;" value="<?php if(isset($_SESSION['start_date'])){echo $_SESSION['start_date']; }?>">
                    </div>
                    <div class="input-group mb-3 input-group-sm mt-sm-3" style="height:40px;">
                        <div class="input-group-prepend">
                            <span class="input-group-text">End Date:</span>
                        </div>
                        <input type="date" id="ADEndDate" name="ADEndDate" class="form-control" required="Please fill this" style="height:40px;" value="<?php if(isset($_SESSION['end_date'])){echo $_SESSION['end_date']; }?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row mx-sm-3 mt-sm-4" >
                <div class="col-sm-12 "  >
                    <div class="input-group mb-3 input-group-sm" style="height:40px;">
                        ...
                        <input type="number" id="ADPercentage" name="ADPercentage" class="form-control" required="Please fill this" placeholder="Example:75" min="0" max="100" style="height:40px;" 
            ...
            <div class="row mx-sm-3 mt-sm-4" >
                <div class="col-sm-12 "  >
                    <input type="submit" class="btn btn-secondary btn-block" name="ADGetData" value="GET DEFAULTER DATA">
                </div>
            </div>
            </form>
        <?php }}?>
        ...
        <?php 
        if(isset($_POST['ADGetData']))
         { 
        if(isset($_POST['ADSubject'])&&isset($_POST['ADStartDate'])&&isset($_POST['ADEndDate'])&&isset($_POST['ADPercentage']))
            {
                $_SESSION['subject']=$_POST['ADSubject']; $_SESSION['start_date']=$_POST['ADStartDate']; $_SESSION['end_date']=$_POST['ADEndDate']; $_SESSION['percentage']=$_POST['ADPercentage'];
                echo("<meta http-equiv='refresh' content='1'>");
            }
        ...
        <div class="col-sm-9">
            <div class="row mx-sm-3 mt-sm-1" >
                <div class="col-sm-12 " >
                        <input class="form-control" id="ADmyInput" type="text" placeholder="Search...">
                    <br>
                <div>
...
$(document).ready(function(){
  $("#ADmyInput").on("keyup", function() {
    var value = $(this).val().toLowerCase();
    $("#ADmyTable tr").filter(function() {
